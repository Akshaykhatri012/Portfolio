        ...
        <div className="services_content">
          ...
          >
            <div className="services_modal-content">
              ...
              <p className="services_modal-title">
                wjdnk skjsmw nks m wk wkwodnwok wwwjbw kwp o2 mkcndcke ed
                ceke2oe2jeme ek2n 2kdm kdj2me kjdo
              </p>
              ...
              <ul className="services_modal-services">
                ...
                <li className="services_modal-service">
                  <i className="uil uil-check-circle services_modal-icon"></i>
                  <p className="services_modal-info">
                    I yyyyy ux element interactions.
                  </p>
                </li>
                ...
                <li className="services_modal-service">
                  <i className="uil uil-check-circle services_modal-icon"></i>
                  <p className="services_modal-info">
                    I create ux wwwww interactions.
                  </p>
                </li>
              </ul>
            </div>
